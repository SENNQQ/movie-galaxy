...
import {ExternalLinksPropsType} from "./types";
import st from './extenralLinks.module.scss'

const ExternalLinks: FC<ExternalLinksPropsType> = ({links, media= ''}) => {
    ...
    return (
        <ul className={st.noList}>
            ...
            {links.imdb_id &&
                <li>
                    {/* eslint-disable-next-line no-useless-concat */}
                    <a href={"https://www.imdb.com/"+ imdb() + "/" + `${links.instagram_id}`}
                       target="_blank"
